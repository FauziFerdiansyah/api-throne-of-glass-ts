...
var loadCharacters = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                characterInfoPromises = characterNames
                    .map(function (characterName) { return getCharacterInfo(characterName); });
            ...
            case 1:
                ...
                values = characters
                    .map(function (character, i) { return [i, character.name, character.species, character.image]; });
                console.log(values);
                sql = 'INSERT INTO Characters (id, name, species, image) VALUES ?';
                connection.query(sql, [values], function (err) {
                    if (err) {
                        console.error("AHHH it did not work");
                        console.error(err);
                    }
                    else {
                        console.log('YAYY');
